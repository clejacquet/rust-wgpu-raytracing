...
impl Triangle {
    pub fn new(device: &wgpu::Device, p0: cgmath::Vector3<f32>, p1: cgmath::Vector3<f32>, p2: cgmath::Vector3<f32>) -> Self {
        let triangle_buffer_data = TriangleBufferData::new(p0, p1, p2);

        let triangle_buffer = device.create_buffer_init(&BufferInitDescriptor {
            label: Some("triangle_buffer"),
            contents: bytemuck::cast_slice(&[triangle_buffer_data]),
